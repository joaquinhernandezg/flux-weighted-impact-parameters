...
def make_summary_table_spaxels(binned_pixel_stats: dict):
    """
    Create an astropy Table summarizing the statistics of each spaxel from the binned pixel statistics.
    """
